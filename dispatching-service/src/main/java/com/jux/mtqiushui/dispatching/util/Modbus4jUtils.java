...
//    }
     ...
     *             异常
     */
    public static Number readHoldingRegister(int slaveId, int offset, int dataType,String ip,int port)
            throws ModbusTransportException, ErrorResponseException, ModbusInitException {
        ...
        Number value = getMaster(ip,port).getValue(loc);
...
//            System.out.println("v023:" + v023);
            ...
            // 03测试
            Number v031 = readHoldingRegister(2, 4, DataType.FOUR_BYTE_INT_SIGNED_SWAPPED,"192.168.1.201",502);// 注意,float
